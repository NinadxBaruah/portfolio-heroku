...
export function HomePage() {
  ...
  return (
    <div className="w-full flex">
      <div className="w-full h-[100vh] relative md:w-[40%] md:max-h-[100vh] scrollbar-hidden hover:scrollbar-auto md:overflow-y-auto">
      ...
      <div className="hidden md:block md:w-[60%] md:h-[100vh] bg-main-page-background bg-gradient-to-r from-[#D2D78D] via-[#D0D8B5] to-[#84B289]"></div>
    </div>
  );
}
